...
export const ComponentDetailsDrawer = ({
  ...
  const templateValue =
    component?.componentData.type === "iam-template" &&
    component?.componentData.templateValue;
    ...
    >
      <Input.Wrapper label="Logical ID" description="" error="">
        <Input
          ref={logicalIdRef}
          defaultValue={
            component && component.componentData.type === "iam-template"
              ? component.componentData.logicalId
              : ""
          }
